...
![Bayesian Kringing LOO-CV Standard Model](path-to-image-here)
![Bayesian Kringing LOO-CV log Model](path-to-image-here)
...
![Universal Kringing LOO-CV Standard Model](path-to-image-here)
![Universal Kringing LOO-CV Log Model](path-to-image-here)
